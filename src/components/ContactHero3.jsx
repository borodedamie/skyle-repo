...
const ContactHero3 = () => {
  return (
    <div className="bg-[#1A1919] h-fit py-[4rem] md:py-0 md:h-[558px] px-[3.5rem] md:px-0  items-center justify-center text-center flex flex-col gap-[2rem]">
      ...
      <h2 className="text-[14px] md:text-[18px] font-[400] text-[white] leading-[24.75px] md:leading-[24.75px] font-AtypDisplay py-[2rem] w-fit md:w-[687px]">
      Contact us today to discuss your marketing goals and let Skyle Designs take your brand to new heights of success and captivating marketing solutions to businesses across various industries.      </h2>
