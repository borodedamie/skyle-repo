...
const Whatwedo = () => {
  return (
    <div className="bg-[#0C0C0C] px-[20px] md:px-[80px]  flex flex-col md:flex-row justify-between items-start pt-[5rem] pb-[0rem] md:pt-[8rem] md:pb-[8rem] gap-[15vw] md:gap-[10vw] lg:gap-[15vw] max-w-[100%] w-[100%]">
      <div className="flex flex-col justify-between gap-y-[2vw] items-start max-w-[100%] md:max-w-[33%]">
