  ...
  return (
    <div className="bg-[#0C0C0C] border-[0.5px] z-[10] md:h-[420px] flex flex-col items-center justify-center bg-transparent mx-auto  text-[white] border-[white] bg-none rounded-[41px]  relative">
        ...
        {screenWidth <= 767 ? (
          ...
          <div className="text-left justify-center flex">
            <div className="grid grid-cols-2 place-items-start md:place-content-start md:grid-cols-5 text-left px-[1rem] md:px-[3rem] py-[5rem] md:py-[4rem] gap-x-[4rem] xl:gap-x-[12rem] gap-y-10 justify-center leading-[16.96px] font-[400] text-[16px]">
